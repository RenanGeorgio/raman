...
/*                                                                            */
/* Title:       cvidef.h                                                      */
/* Purpose:     To define macros for conditional header processing.           */
/*                                                                            */
/*============================================================================*/
 ...
 */
#if (!defined(_NI_mswin32_)) && (defined(_NI_mswin64_)||defined(__WIN64__)||defined(_WIN64)||defined(WIN64))
    #ifndef WIN64
        #define WIN64 1
    #endif
    #ifndef WIN32
    ...
    #endif
    #ifndef _NI_mswin64_
        #define _NI_mswin64_ 1
    #endif
#endif
#if (!defined(_NI_mswin16_) && !defined(_NI_mswin64_)) && (defined(_NI_mswin32_)||defined(__WIN32__)||defined(__NT__)||defined(_WIN32)||defined(WIN32))
    #ifndef WIN32
        #define WIN32 1
    #endif
    #ifndef _NI_mswin32_
    ...
    #endif
#endif
#if defined(_NI_mswin16_) || defined(_NI_mswin32_) || defined(_NI_mswin64_)
    #ifndef _NI_i386_
        #define _NI_i386_ 1
    #endif
    #ifndef _NI_mswin_
...
#if (defined(_NI_sparc_) && _NI_sparc_) || (defined(_NI_hpux_) && _NI_hpux_) || (defined(_NI_linux_) && _NI_linux_)
...
#if (defined(_NI_mswin64_) && _NI_mswin64_) || (defined(_NI_linux64_) && _NI_linux64_)
...
#define _CVI_PROFILE_LEVEL_DISABLED_        0
#define _CVI_PROFILE_LEVEL_FUNCS_           1
#define _CVI_PROFILE_LEVEL_FUNCS_AND_CALLS_ 2

#if defined(CVI_UTF8) && defined(CVI_INSTRSUP_COMPAT)
#pragma message ("CVI_INSTRSUP_COMPAT define has effect only when the project encoding is ANSI.")
#endif
