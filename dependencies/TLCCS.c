...
// I/O Communication
__declspec(dllexport) ViStatus tlccs_USB_out(ViSession vi, ViInt16 bRequest, ViUInt16 wValue, ViUInt16 wIndex, ViUInt16 wLength, ViBuf Buffer);
__declspec(dllexport) ViStatus tlccs_USB_in(ViSession vi, ViInt16 bRequest, ViUInt16 wValue, ViUInt16 wIndex, ViUInt16 wLength, ViBuf Buffer, ViPUInt16 Read_Bytes);
...
__declspec(dllexport) ViStatus tlccs_setSerialNumber(ViSession vi, ViPChar serial);  

__declspec(dllexport) ViStatus tlccs_setDarkCurrentOffset(ViSession vi, ViUInt16 evenOffset, ViUInt16 oddOffset);
__declspec(dllexport) ViStatus tlccs_getDarkCurrentOffset(ViSession vi, ViPUInt16 even, ViPUInt16 odd); 

__declspec(dllexport) ViStatus tlccs_writeEEPROM(ViSession vi, ViUInt16 addr, ViUInt16 idx, ViUInt16 len, ViBuf buf, ViUInt16 *chksum);
__declspec(dllexport) ViStatus tlccs_writeEEPROM_wo_crc(ViSession vi, ViUInt16 addr, ViUInt16 idx, ViUInt16 len, ViBuf buf);
__declspec(dllexport) ViStatus tlccs_readEEPROM(ViSession vi, ViUInt16 addr, ViUInt16 idx, ViUInt16 len, ViBuf buf, ViUInt16* cnt);
__declspec(dllexport) ViStatus tlccs_readEEPROM_wo_crc(ViSession vi, ViUInt16 addr, ViUInt16 idx, ViUInt16 len, ViBuf buf, ViUInt16* cnt);
...
---------------------------------------------------------------------------*/
ViStatus _VI_FUNC tlccs_setWavelengthData (ViSession vi, ViUInt32 pixelDataArray[],
...
---------------------------------------------------------------------------*/
ViStatus _VI_FUNC tlccs_getUserCalibrationPoints (ViSession vi, ViUInt32 pixelDataArray[],
...
---------------------------------------------------------------------------*/
__declspec(dllexport) ViStatus tlccs_writeEEPROM(ViSession vi, ViUInt16 addr, ViUInt16 idx, ViUInt16 len, ViBuf buf, ViPUInt16 chksum)
{
   ViStatus err = VI_SUCCESS;
   uint16_t sum = 0;
...
---------------------------------------------------------------------------*/
__declspec(dllexport) ViStatus tlccs_readEEPROM(ViSession vi, ViUInt16 addr, ViUInt16 idx, ViUInt16 len, ViBuf buf, ViPUInt16 cnt)
{
   ViStatus err = VI_SUCCESS;   
   uint16_t sum = 0; 
   uint16_t ees = 0;
...
/*---------------------------------------------------------------------------
   ...
   ViPUInt16 cnt:             The number of Bytes actually read
---------------------------------------------------------------------------*/
__declspec(dllexport) ViStatus tlccs_readEEPROM_wo_crc(ViSession vi, ViUInt16 addr, ViUInt16 idx, ViUInt16 len, ViBuf buf, ViPUInt16 cnt)
{
   ViStatus err = VI_SUCCESS;   
...
---------------------------------------------------------------------------*/
static ViStatus tlccs_checkNodes(ViUInt32 pixel[], ViReal64 wl[], ViInt32 cnt)
{
   int      i;
   ViInt32  p;
   ViReal64 d;
...
---------------------------------------------------------------------------*/
static ViStatus tlccs_nodes2poly(ViUInt32 pixel[], ViReal64 wl[], ViInt32 cnt, ViReal64 poly[])
{
